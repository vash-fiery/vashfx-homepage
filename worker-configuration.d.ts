/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fa597c66250934f13e3b106dcde2b667)
// Runtime types generated with workerd@1.20260910.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	VITE_GLOB_API_URL: string;
	VITE_APP_API_BASE_URL: string;
	VITE_GLOB_OPEN_LONG_REPLY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_GLOB_API_URL" | "VITE_APP_API_BASE_URL" | "VITE_GLOB_OPEN_LONG_REPLY" | "VITE_GLOB_APP_PWA">> {}
}
